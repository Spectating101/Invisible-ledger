...
| `market/` | Daily prices, events and exploratory outputs | Event interpretation remains unresolved |
...
For current proposal/manuscript drafting, use `docs/CANONICAL_EMPIRICAL_RESULTS_2026-09-12.md` as the human-readable result authority and `docs/RESULT_AUTHORITY_MAP_2026-09-12.md` for document roles. The first executed tests remain under `outputs/hypothesis_tests_2026-09-10/` and are documented in `reports/HYPOTHESIS_TESTS_2026-09-10.md`; they are dated execution snapshots and do not define an approved main sample.
...
- Indonesia-aligned direct annual candidate design: **13 current economic periods** across Blibli, Bukalapak, and Tokopedia before final geographic/scope admission. The older 14-period audit count is lineage only and included Tokopedia FY2021, now hard-excluded for period mismatch.
