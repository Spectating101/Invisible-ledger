...
`bps_marketplace_business_level_published_evidence_2026-09-10.csv` transcribes
selected statistics and the financial-statement odds ratio published in BPS's
2025 marketplace analysis using the 2024 E-Commerce Survey. These are BPS's
published business-level results, not estimates generated by this repository.
The archived publication is
`sources/core_public_documents/bps_marketplace_benefits_risks_2025.pdf`.
