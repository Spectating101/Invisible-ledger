...
def main() -> None:
    goto = text(SOURCES / "goto_annual_report_2023.pdf")
    ...
    grab = text(SOURCES / "grab_2023_results.htm")
    ...
    trade = text(SOURCES / "us_trade_indonesia_ecommerce.html")
    omdia = text(SOURCES / "omdia_sea_ecommerce_country_spotlight.pdf")
    food = text(SOURCES / "katadata_indonesia_food_delivery_2023.html")
