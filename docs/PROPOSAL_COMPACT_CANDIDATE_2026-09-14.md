...
This historical candidate is intentionally reduced to a pointer so obsolete proposal prose cannot be mistaken for current content by GitHub/code search.
