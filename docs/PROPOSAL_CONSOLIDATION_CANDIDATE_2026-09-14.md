# SUPERSEDED proposal candidate

This historical consolidation candidate is intentionally reduced to a pointer so obsolete proposal prose cannot be mistaken for current content by GitHub/code search.
...
See `docs/archive/PROPOSAL_HISTORY_INDEX_2026-09-15.md` and `/CANONICAL_ARTIFACTS.md`.
