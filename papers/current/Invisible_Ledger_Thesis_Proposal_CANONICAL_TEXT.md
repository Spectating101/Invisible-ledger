...
Source DOCX SHA-256: `bc1b9804d4bf3e82cd8adb722a5da8cbea590e38f23276403eca315fe641fa32`.
...
Southeast Asia's digital economy grew from US$100 billion in gross transaction value in 2020 to US$263 billion in 2024 (Google, Temasek and Bain 2020, 2024; reported there as gross merchandise value). The numbers used to describe that growth come from three kinds of record: platform accounts, which report what platforms earn; e-commerce and marketplace statistics, which report sales through particular channels; and payment statistics, which report the value moving through digital payment systems. They are commonly used as interchangeable measures of the same activity. This proposal argues that they are not interchangeable, and that treating them as such produces systematically wrong measurement of platform economies. In Indonesia, platform revenue understates the level of the commerce platforms carry by more than an order of magnitude and overstates its growth, marketplace statistics miss almost all of the recent expansion, and payment data grow many times faster than the commerce they settle.

Suppose a platform processes 100 units of transaction value and recognises 10 as revenue. The other 90 units are recorded in the platform's systems as merchant receipts, driver payouts, inventory costs and other pass-through payments, and never appear as platform revenue. An analyst sizing the platform from its accounts sees 10; an analyst sizing it from its transaction data sees 100. I call the difference the invisible wedge.

For FY2023, three documented Indonesian platform cases processed US$43.23 billion of transaction value against US$3.16 billion of recognised revenue, leaving a wedge of US$40.07 billion. The wedge alone is equivalent to 2.9 percent of Indonesia's US$1.371 trillion GDP. It remains above US$20 billion when any one platform is removed, and it moves by less than half a billion dollars across the plausible range of its key monetisation assumption, as Section 5.1 shows.

The wedge is invisible in a specific sense. Platforms hold detailed, seller-linked records of the full transaction value, but only the revenue share reaches their financial statements, and the transaction records themselves do not routinely enter third-party income reporting. Indonesia's Regulation PMK 37/2025 is the first attempt to route those records to the tax authority, and Section 5.3 shows how small a part of the activity its design can reach.

### 1.1 Research question and objectives

One question drives the proposal:

How large is the gap between the commerce Indonesian platforms carry and the revenue their accounts record, how does it move over time, and what does it imply for how the digital economy is measured?

The proposal pursues this through three objectives. It measures the wedge across FY2020-FY2025 for five Indonesian platform series, keeping observations separated by how directly they map to Indonesia. It explains the wedge's movements using revenue components the platforms themselves disclose. And it sets platform-based measures against national e-commerce statistics and payment data to establish how far each departs from the others. Evidence from 48 issuer-years of platforms outside Indonesia tests whether the same boundary appears in other markets and business models (Section 5.3).

### 1.2 Contributions

First, a longitudinal measure of the wedge. The evidence extends from a single-year snapshot to seventeen platform-year observations over FY2020-FY2025, and shows that the ratio of transaction value to revenue changes substantially within the same platform from year to year.

Second, a mechanism. Material movements in the wedge are traced to disclosed monetisation, customer incentives, gross-versus-net recognition and business perimeter. In the cleanest case, Tokopedia's net revenue rose 53.2 percent in a year in which its transaction value fell 8.9 percent, mostly through lower customer incentives.

Third, a demonstration that the standard measures of digital commerce are not interchangeable. Combining issuer evidence with national statistics from BPS-Statistics Indonesia (Badan Pusat Statistik), Bank Indonesia payment data and Regulation PMK 37/2025 (Peraturan Menteri Keuangan), administered by the Directorate General of Taxes (DJP), the thesis shows that platform revenue, marketplace statistics and payment data each misstate Indonesian digital commerce in a different direction, and that the new marketplace reporting regime inherits the limits of the channel it targets.

### 1.3 Positioning the contribution

The contribution is a finance measurement problem before it is a tax-policy one. Investors, statistical agencies and tax authorities each draw conclusions about the scale, growth and monetisation of platform businesses from whichever record they have to hand, and those conclusions differ because the records differ. De Franco, Kothari and Verdi (2011) show that users draw better inferences when accounting bases are comparable, and Berg et al. (2020) show that intermediary-held digital traces carry information conventional records lack. This proposal applies both results to platform economies and shows that the choice of record, usually treated as a question of data availability, changes the answer.
