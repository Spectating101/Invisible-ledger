...
For the current certification overlay—corrected Indonesia candidate counts, hard exclusions, BPS established-versus-conditional status, and the direct/conditional sample hierarchy—read [the empirical certification reconciliation](docs/EMPIRICAL_CERTIFICATION_RECONCILIATION_2026-09-10.md).
...
The comprehensive backend census is generated by [`scripts/analysis/build_comprehensive_empirical_audit.py`](scripts/analysis/build_comprehensive_empirical_audit.py).
Read [`reports/EMPIRICAL_BACKEND_AUDIT_2026-09-09.md`](reports/EMPIRICAL_BACKEND_AUDIT_2026-09-09.md) or open the executed notebook in `notebooks/` before interpreting row counts.
